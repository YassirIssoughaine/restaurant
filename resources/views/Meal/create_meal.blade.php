        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body text-right">
                        <ul class="list-group">
                            <a href="{{route('cat.show')}}" class="list-group-item list-group-item-action">اضافة صنف</a>
             ...
             <div class="card">
                 ...
                 <form action="{{ route('meal.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body text-right">
                        ...
                        <div class="form-group">
                            <label for="name">وصف الوجبة</label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                ...
                                <br>
                                <div class="form-group">
                                    <img id="showImage" src="{{url('upload/no-image.png')}}" style="width: 100px; height: 100px">
                                </div>
